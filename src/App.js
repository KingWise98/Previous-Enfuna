...
import Driver_Agent from "./admins/driver/agent";
import Driver_Wallet from "./admins/driver/wallet";
...
import Rider_Agent from "./admins/rider/agent";
import Rider_Wallet from "./admins/rider/wallet";
        ...
        <div className="app">
          ...
          <main className="content">
            ...
            <Routes>
              ...
              <Route path="/driver/agent" element={
                <ProtectedRoute allowedRoles={["driver"]}>
                  <Driver_Agent />
                </ProtectedRoute>
              } />
              ...
              <Route path="/driver/group" element={
               ...
               <Route path="/driver/earning" element={
                <ProtectedRoute allowedRoles={["driver"]}>
                  <Driver_Earning />
                </ProtectedRoute>
              } />

              <Route path="/driver/queue" element={
                <ProtectedRoute allowedRoles={["driver"]}>
                  <Driver_Queue />
                </ProtectedRoute>
              } />
              ...
              <Route path="/rider/earning" element={
                <ProtectedRoute allowedRoles={["rider"]}>
                  <Rider_Earning />
                </ProtectedRoute>
              } />
              ...
              <Route path="/rider/agent" element={
                <ProtectedRoute allowedRoles={["rider"]}>
                  <Rider_Agent />
                </ProtectedRoute>
              } />
